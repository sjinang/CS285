...
class FFModel(BaseModel):
    ...
    def define_forward_pass(self):
        ...
        self.next_obs_pred = self.delta_pred_unnormalized + self.obs_pl # TODO(Q1) Predict next observation using current observation and delta prediction (not that next_obs here is unnormalized)
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        return self.sess.run([self.delta_pred_unnormalized],feed_dict=feed_dict)[0] # TODO(Q1) Run model prediction on the given batch of data
