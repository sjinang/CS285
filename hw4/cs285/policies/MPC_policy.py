    ...
    def get_action(self, obs):
        ...
        for model in self.dyn_models:
            ...
            for t in range(self.horizon):
                reward, dones = self.env.get_reward(current_obs, candidate_action_sequences[:,t,:])
                total_rewards += reward
                current_obs = model.get_prediction(current_obs, candidate_action_sequences[:,t,:], self.data_statistics)
            predicted_rewards_per_ens.append(total_rewards)
