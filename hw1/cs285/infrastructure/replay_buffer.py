...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        ind = np.random.permutation(self.obs.shape[0])
        return self.obs[ind][:batch_size], self.acs[ind][:batch_size], self.rews[ind][:batch_size], self.next_obs[ind][:batch_size], self.terminals[ind][:batch_size]
