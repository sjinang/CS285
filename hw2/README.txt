...
*** [MUST] Before running please perform this line of code : 
$ python3 setup.py develop 

##############################################

$ python3 cs285/scripts/run_hw2_policy_gradient.py --env_name CartPole-v1 --exp_name test_pg_cartpole
$ python3 cs285/scripts/run_hw2_policy_gradient.py --env_name InvertedPendulum-v2 --exp_name test_pg_pendulum
...
NOTE : if the above(^) command of tensorboard does not give an authentic web address then refer to the following line of code instead.
