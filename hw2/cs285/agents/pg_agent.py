...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        discounts = np.array([self.gamma**t for t in indices])
        ...
        list_of_discounted_returns = np.array([sum_of_discounted_rewards for i in indices])
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)): 
            ...
            discounts = np.array([self.gamma**(t-start_time_index) for t in indices])
            ...
            discounted_rtg = discounts * np.array(rewards[start_time_index:])
